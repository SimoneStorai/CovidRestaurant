function getMenu(cat) {
  $.get("../api/getDishes.php", { category: cat, ignoreEmpty: true })
    .done(function(data) {
        var output = '';
        for (var i = 0; i < data.length; i++)
        {
          ...
          var waiting_time = data[i].description;
          ...
          <div class="menu-item-con">
            <div class="menu-item" id="${id}" onclick="addOrder(${id}, '${name}', ${price})" style="background: url('${image_url}') no-repeat center;>
              ...
              <div class="price-con">${price}</div>
              <div class="waiting-time-con">${price}</div>
